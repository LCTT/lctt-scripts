...
feeds="https://fedoramagazine.org/feed/ https://www.networkworld.com/index.rss https://www.linux.com/feeds/blogs/community/rss https://itsfoss.com/feed/ https://opensource.com/feed"
if [[ $# -ne 0 ]];then
    feeds="$*"
fi
